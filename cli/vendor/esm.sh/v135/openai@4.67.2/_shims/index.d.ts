 ...
 */
import { manual } from "./manual-types.d.ts";
import * as auto from 'https://esm.sh/v135/openai@4.67.2/_shims/auto/types.d.ts';
import { type RequestOptions } from "../core.d.ts";
