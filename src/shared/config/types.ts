 ...
 *
 * This is stored in the project's $globalConfig/projects/$projectId/config.yaml file.
 */
...
export interface ProjectConfigV20 extends ProjectConfigV2 {
	settings?: {
...
export interface ProjectConfigV21 extends ProjectConfigV2 {
	settings?: {
		api?: Partial<ApiConfig>;
		bui?: Partial<BuiConfig>;
		cli?: Partial<CliConfig>;
