...
import { type ResourceSuggestion, suggestResources } from 'api/utils/resourceSuggestions.ts';
...
Deno.test({
	name: 'suggestResources - Test markdown file patterns',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);

			// Test 'docs/*.md' pattern
			let result = await suggestResources({
			...
			assert(
				result.suggestions.some((suggestion: ResourceSuggestion) =>
...
Deno.test({
	name: 'suggestResources - Test type filtering',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
...
Deno.test({
	name: 'suggestResources - Test path separator handling',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
...
Deno.test({
	name: 'suggestResources - Test multiple extensions and complex patterns',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
...
Deno.test({
	name: 'suggestResources - Test special characters in paths',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
...
Deno.test({
	name: 'suggestResources - Test limit handling',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
...
Deno.test({
	name: 'suggestResources - Test case sensitivity',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
...
Deno.test({
	name: 'suggestResources - Test hidden files and directories',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
...
Deno.test({
	name: 'suggestResources - Test empty and invalid patterns',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
...
Deno.test({
	name: 'suggestResources - Test exact directory name "docs"',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
...
Deno.test({
	name: 'suggestResources - Test partial directory name "doc"',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
...
Deno.test({
	name: 'suggestResources - Test `docs/` pattern',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
...
Deno.test({
	name: 'suggestResources - Test `docs/d` pattern',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
...
Deno.test({
	name: 'suggestResources - Test `docs/development` pattern',
	fn: async () => {
		await withTestProject(async (testProjectId, testProjectRoot) => {
			await createTestFiles(testProjectRoot);
