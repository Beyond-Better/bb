					...
					<div className='flex items-center space-x-6 text-sm'>
						<div className='flex items-center text-blue-600'>
							...
							<div>
								...
								{chatState.value.collaborations.length < chatState.value.totalCollaborations
									? (
										<div className='text-xs text-gray-400 dark:text-gray-500'>
											Loaded {chatState.value.collaborations.length.toLocaleString()} of{' '}
											{chatState.value.totalCollaborations}
										</div>
									)
									: null}
							</div>
