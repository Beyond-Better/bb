...
import type { ConversationId, ConversationContinue, ConversationResponse, ConversationStats, TokenUsage } from 'shared/types.ts';
...
export function createWebSocketManagerChat(config: ChatWebSocketConfig): WebSocketManagerChat {
