...
import type { WebSocketConfigApp } from '../types/websocket.types.ts';
...
export class WebSocketManagerApp extends WebSocketManagerBaseImpl {
	constructor(config: WebSocketConfigApp) {
		super(config);
	}
...
export function createWebSocketManagerApp(config: WebSocketConfigApp): WebSocketManagerApp {
