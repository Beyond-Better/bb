...
export function AgentTaskGroup({
  ...
  projectId,
  conversationId,
}: AgentTaskGroupProps): JSX.Element {
  ...
  return (
    <div className="agent-task-group bg-gray-50 dark:bg-gray-800 rounded-md overflow-hidden mb-4 border border-gray-200 dark:border-gray-700">
      {/* Group Header */}
      <div 
      ...
      >
        <div className="flex items-center">
          <span className="mr-2">
            <svg 
              className={`w-4 h-4 text-gray-500 dark:text-gray-400 transform transition-transform duration-200 ${isExpanded ? 'rotate-90' : ''}`}
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
            >
          ...
          <div>
            <h3 className="font-medium text-sm">Agent Task Group</h3>
