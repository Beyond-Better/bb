			...
			<div class='space-y-6'>
				...
				<div class='flex items-center justify-between'>
					...
					<button
						...
						disabled={isTemporarilyDisabled || false}
					>
						<span
						...
						<div>
							...
							<div class='relative'>
								...
								<input
									...
									onInput={(e) => minBalance.value = parseFloat((e.target as HTMLInputElement).value) || 0}
						...
						<div>
							...
							<div class='relative'>
								...
								<input
									...
									onInput={(e) => purchaseAmount.value = parseFloat((e.target as HTMLInputElement).value) || 0}
									class='pl-7 w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500'
									placeholder='20.00'
								/>
							</div>
						...
						<div>
							...
							<div class='relative'>
								...
								<input
									...
									onInput={(e) => dailyLimit.value = parseFloat((e.target as HTMLInputElement).value) || 0}
									class='pl-7 w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500'
									placeholder='100.00'
								/>
							</div>
				...
				{status.value && (
					<div class='pt-6 border-t border-gray-200 dark:border-gray-700'>
						...
						{status.value.recent_purchases.length > 0 && (
							<div class='mt-6'>
								<h5 class='text-sm font-medium text-gray-700 dark:text-gray-300 mb-3'>Recent Auto Top-ups</h5>
								<div class='space-y-2'>
									{status.value.recent_purchases.slice(0, 5).map(purchase => (
										<div key={purchase.purchase_id} class='flex justify-between items-center py-2 px-3 bg-gray-50 dark:bg-gray-700 rounded'>
											<div>
