			...
			<div class='mx-auto max-w-7xl px-6 lg:px-8 pb-24'>
				<div class='mx-auto max-w-2xl lg:text-center'>
					...
					<p class='mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400'>
						Beyond Better (BB) is your AI-powered agentic assistant that handles complexity across research,
						content creation, analysis, and development projects.
					</p>
				</div>
				...
				<div class='mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none'>
					<dl class='grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3'>
						...
						<div class='flex flex-col'>
							...
							<dd class='mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-400'>
								<p class='flex-auto'>
									Your projects stay on your machine. BB runs locally, ensuring your intellectual
									property and sensitive data remain secure.
								</p>
							</dd>
						</div>
