...
import * as confirmationTokens from './confirmation-tokens.d.ts';
import * as orders from './orders.d.ts';
import * as tokens from './token-and-sources.d.ts';
import * as elements from './elements/index.d.ts';
import * as financialConnections from './financial-connections.d.ts';
import * as ephemeralKeys from './ephemeral-keys.d.ts';

import {
  StripeElements,
  StripeElementsOptionsClientSecret,
  StripeElementsOptionsMode,
} from './elements-group.d.ts';
import {CheckoutLocale, RedirectToCheckoutOptions} from './hosted-checkout.d.ts';
...
import {StripeCheckoutOptions, StripeCheckout} from './checkout.d.ts';
import {
  StripeEmbeddedCheckoutOptions,
  StripeEmbeddedCheckout,
} from './embedded-checkout.d.ts';
